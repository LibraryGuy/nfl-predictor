...
def load_nfl_data_pro():
    try:
        # Loading 2024 and 2025 seasons for current Wild Card data
        ...
        # Checks for common naming variations in the nflverse dataset
        ...
        # Clean strings (Now works because 'player_name' is a 1D Series)
        ...
        # We target 'passing_passing_yards' (flattened total) vs 'passing_yards_per_att'
        ...
        # Merge for home and away separately to ensure no games are missed
        ...
        final_df = pd.concat([df_home, df_away], ignore_index=True).fillna(0)
        return final_df
...
if not data.empty:
    ...
    m3.metric("Wind Speed", f"{latest.get('wind', 0)} mph")
    ...
    # FOOTER INFO BOX (Weather, Field, Lines)
