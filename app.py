...
def load_advanced_data():
    try:
        ...
        return df # CRITICAL: Ensure a DataFrame is returned
...
# --- THE FIX: SAFETY GUARD ---
if data.empty:
    st.warning("🔄 The NFL data is currently unavailable. Please check your internet and click 'Rerun' in the top right menu.")
    st.stop() # Stops the app here so it doesn't crash on the lines below
...
# line 74 is now safe because we checked if data is empty above
